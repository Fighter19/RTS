...
// This is required for FFmpeg older than 4.0 -> deprecated afterwards though
	...
	m_streamCount = m_fmtCtx->nb_streams;
	DEBUG_ASSERTCRASH(m_streamCount <= MAX_STREAMS, ("too many streams in file"));
...
Bool FFmpegFile::decodePacket()
{
	...
	DEBUG_ASSERTCRASH(m_streamCount > stream_idx, ("stream index out of bounds"));
