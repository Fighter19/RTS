...
static void handlePlayerSelection(int index)
{
  ...
  UnicodeString title = GadgetComboBoxGetText(combo);
	playerType = (IntPtr)GadgetComboBoxGetItemData(combo, selIndex);
...
static void handleColorSelection(int index)
{
	...
	Int color, selIndex;
	GadgetComboBoxGetSelectedPos(combo, &selIndex);
	color = (IntPtr)GadgetComboBoxGetItemData(combo, selIndex);
...
static void handlePlayerTemplateSelection(int index)
{
	...
	GadgetComboBoxGetSelectedPos(combo, &selIndex);
	playerTemplate = (IntPtr)GadgetComboBoxGetItemData(combo, selIndex);
	GameInfo *myGame = TheSkirmishGameInfo;
...
static void handleTeamSelection(int index)
{
	...
	Int team, selIndex;
	GadgetComboBoxGetSelectedPos(combo, &selIndex);
	team = (IntPtr)GadgetComboBoxGetItemData(combo, selIndex);
	GameInfo *myGame = TheSkirmishGameInfo;
