...
class TPoint2D {
	public:
		...
		TPoint2D<T> const operator * (T rvalue) const {return(TPoint2D<T>(this->X * rvalue, this->Y * rvalue));}
		...
		TPoint2D<T> const operator * (TPoint2D<T> const & rvalue) const {return(TPoint2D<T>(this->X * rvalue.X, this->Y * rvalue.Y));}
		TPoint2D<T> const Dot_Product(TPoint2D<T> const & rvalue) const {return(TPoint2D<T>(this->X * rvalue.X, this->Y * rvalue.Y));}
